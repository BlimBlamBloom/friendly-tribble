// js/hooks/useVocabGameLogic.js

const { useState } = React;

export const useVocabGameLogic = () => {
    ...
    const handleDropClick = (drop, drops, setDrops) => {
        ...
        if (!selectedDrop) {
            ...
            // Check if words match (spanish-chinese pair)
            if (selectedDrop.matchData.word === drop.matchData.word) {
